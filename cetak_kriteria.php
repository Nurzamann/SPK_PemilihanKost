...
$pdf->Cell(0, 10, 'Data Kriteria', 0, 1, 'C');
$pdf->Ln(5);
...
$pdf->Cell(35, 10, 'Kode Kriteria', 1, 0, 'C', true);
$pdf->Cell(60, 10, 'Nama Kriteria', 1, 0, 'C', true);
$pdf->Cell(45, 10, 'Bobot', 1, 0, 'C', true);
$pdf->Cell(50, 10, 'Jenis Kriteria', 1, 1, 'C', true);
...
while ($row = $result->fetch_assoc()) {
    $pdf->Cell(35, 10, $row['kode_kriteria'], 1, 0, 'C');
    $pdf->Cell(60, 10, $row['nama_kriteria'], 1, 0, 'C');
    $pdf->Cell(45, 10, $row['bobot'], 1, 0, 'C');
    $pdf->Cell(50, 10, $row['jenis_kriteria'], 1, 1, 'C');
}

$tanggal_sekarang = $pdf->format_tanggal_id(date('Y-m-d'));

$pdf->Output("Laporan_Kriteria.pdf", "I");
exit;
